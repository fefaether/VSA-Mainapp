...
- 利用規約（日本語）: https://fefaether.github.io/VSA-Mainapp-Release/ja/terms.html
- プライバシーポリシー（日本語）: https://fefaether.github.io/VSA-Mainapp-Release/ja/privacy.html
- Terms of Service: https://fefaether.github.io/VSA-Mainapp-Release/en/terms.html
- Privacy Policy: https://fefaether.github.io/VSA-Mainapp-Release/en/privacy.html
- ライセンス情報: https://fefaether.github.io/VSA-Mainapp-Release/license.html

Google OAuthの公開設定に掲載するプライバシーポリシーURLは、VSAウェブサイトのプライバシーポリシーページ（`/ja/privacy` または `/en/privacy`）を使用します。条項全文の最新正本は本 GitHub Pages 上の利用規約・プライバシーポリシーを参照してください。
